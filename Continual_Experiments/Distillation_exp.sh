...
python3 main_cont.py -cs 5,5 -e 500,500 -de 200,200 --dataset cifar10 --lambda_param 5e-3 --scale_loss 0.1 --proj_out 2048 --proj_hidden 2048 --min_lr 1e-6 --pretrain_warmup_epochs 10 --pretrain_warmup_lr 3e-3 --pretrain_weight_decay 1e-4 --normalization batch --cuda_device 3 --appr 'barlow_diffusion' --pretrain_base_lr 0.1 --diff_train_bs 128 --sample_bs 64 --diff_weight_decay 5e-4 --diff_train_lr 1e-4 --unet_model openai  --msize 10000 --image_report_freq 49 --knn_report_freq 10 --class_condition
...
python3 main_cont.py -cs 5,5 -e 1,1 -de 1,1 --dataset cifar10 --lambda_param 5e-3 --scale_loss 0.1 --proj_out 2048 --proj_hidden 2048 --min_lr 1e-6 --pretrain_warmup_epochs 10 --pretrain_warmup_lr 3e-3 --pretrain_weight_decay 1e-4 --normalization batch --cuda_device 5 --appr 'barlow_diffusion' --pretrain_base_lr 0.3 --diff_train_bs 128 --sample_bs 64 --diff_weight_decay 5e-4 --diff_train_lr 1e-4 --unet_model openai --class_condition --image_report_freq 1 --knn_report_freq 1 --msize 1000 

python3 main_cont.py -cs 5,5 -e 1,1 -de 200,200 --dataset cifar10 --lambda_param 5e-3 --scale_loss 0.1 --proj_out 2048 --proj_hidden 2048 --min_lr 1e-6 --pretrain_warmup_epochs 10 --pretrain_warmup_lr 3e-3 --pretrain_weight_decay 1e-4 --normalization batch --cuda_device 6 --appr 'barlow_diffusion' --pretrain_base_lr 0.3 --diff_train_bs 128 --sample_bs 64 --diff_weight_decay 5e-4 --diff_train_lr 1e-4 --unet_model openai --class_condition --image_report_freq 49 --knn_report_freq 1 --msize 1000 --class_condition --beta_scheduler "linear" --noise_scheduler DDIM 
