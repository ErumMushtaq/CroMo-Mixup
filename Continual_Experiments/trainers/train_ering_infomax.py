        ...
        for epoch in range(args.epochs[task_id]):
            ...
            for x1, x2, y in loader:   
                ...
                if task_id > 0:                    
                    ...
                    # for xx1, xx2, y in past_data_loader: 
                    # zz1, zz2 = model(xx1, xx2)

                        # zz1 = F.normalize(zz1, p=2)
                        # zz2 = F.normalize(zz2, p=2)
                        # cov_loss2 =  covarince_loss(zz1, zz2)

                        # if args.info_loss == 'invariance':
                        #     sim_loss2 =  invariance_loss(z1, z2)
                        # elif args.info_loss == 'error_cov': 
                        #     sim_loss2 = err_covarince_loss(z1, z2)
                        # loss2 = (args.sim_loss_weight * sim_loss2) + (args.cov_loss_weight * cov_loss2)
                        # loss_mem = loss2
                    ...
                    x2 = torch.cat([x2, xx2], dim=0)
                        ...
                        # zzz1 = F.normalize(zzz1, p=2)
                        # zzz2 = F.normalize(zzz2, p=2)
                        # cov_loss2 =  covarince_loss(zzz1, zzz2)
