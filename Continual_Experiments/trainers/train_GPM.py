...
def train_GPM_infomax(model, train_data_loaders, knn_train_data_loaders, test_data_loaders, device, args):#just for 2 tasks
    ...
    for task_id, loader in enumerate(train_data_loaders):
        ...
        for epoch in range(args.epochs[task_id]):
            ...
            for x1, x2, y in loader:
                ...
                optimizer.zero_grad()
                loss = loss_task  + args.lambda_norm * loss_norm
                loss.backward()
