...
def train_cassle_barlow_ering_contrast(model, train_data_loaders, knn_train_data_loaders, test_data_loaders, train_data_loaders_linear, device, args, transform, transform_prime):
    ...
    for task_id, loader in enumerate(train_data_loaders):
        ...
        if task_id == 0 and args.start_chkpt == 1:
            model_path = "./checkpoints/checkpoint_cifar100-algobarlow_ering_contrast-e[1, 1, 1, 1, 1]-b256-lr0.3-CS[20, 20, 20, 20, 20]_task_0_same_lr_True_norm_batch_ws_False.pth.tar"
            ...
            for epoch in range(args.epochs[task_id]):
                ...
                if task_id == 0:
                    ...
                    for cur_data in loader:
                        ...
                        # x1_old = transform(x_old[indices])
                        # x2_old = transform_prime(x_old[indices])
                        ...
                        if args.appr == 'barlow_ering_contrast':
                            ...
                            f2_old = features_old[indices]
                            # print('barlow_ering_negcontrast')
